...
PROJECTS_SCHEMA = {
    ...
    "Screening Score": {"number": {"format": "number"}},
    "Team Score": {"number": {"format": "number"}},
    "Traction Score": {"number": {"format": "number"}},
    "Risk Level": {"select": {}},
...
def sync_project(
    ...
    properties = {
        ...
        "Country / Region": select(project.get("country_or_region")),
        ...
        "Customer Type": select(project.get("customer_type")),
        "Revenue Stage": select(project.get("revenue_stage")),
        ...
        "Screening Score": number(project.get("screening_score") or 0),
        "Team Score": number(project.get("team_score") or 0),
        "Traction Score": number(project.get("traction_score") or 0),
        "Risk Level": select(project.get("risk_level")),
